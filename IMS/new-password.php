...
<body>
    <div class="reset-container">
        <div class="container">
            ...
            ?>
                    <form class="new-pwd-form" action="PHP-Scripts/reset-password-script.php" method="post">
                        ...
                        <hr class="divider">
                        <button type="submit" name="reset-password-submit" class="reset-password-submit">Reset Password</button>
                    </form>
            <?php
                }
            }
